    	<div class="left">
            ...
            <div class="box">
                ...
                <dl class="two"><dt>New Supplier</dt><dd>
                <?php 
				...
				$values = '';
                    ...
                    <p class="desc">New supplier signup will be notified to the email to the above email address.<br />
                    For additional emails seperate addresses by a comma</p>
                	</dd></dl>
            	<dl class="two"><dt>Quote Request</dt><dd>
            	<?php 
				...
				$values = '';
                    ...
                    <p class="desc">Quote request will be emailed to the email to the above email address.<br />
For additional emails seperate addresses by a comma</p>
                    </dd></dl>
