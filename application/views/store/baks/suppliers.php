...
<div id="home_top_container">
	<div class="supplier_form_bg main-bg">	  
        ...
        <div class="content-top">
            <h1>SUPPLIERS</h1>
            <p class="gray" style="font-size:22px;margin-top:10px; width:868px; text-align:justify;">
               	Join the Removalist Quote network and start winning work today!<br /><br />
Suppliers are subject to Removalist Quotes quality and standards checks, to find out more about signing up as a supplier please <a href="<?=base_url()?>store/suppliermore">click here</a>.<br /><br />
